...
:main_menu 
cls 
title PLATINUM+ OPTIMIZER 7.2 By @STEFANO83223, @Aledect
color 0B
echo. 
echo. 
echo                        ██████╗░██╗░░░░░░█████╗░████████╗██╗███╗░░██╗██╗░░░██╗███╗░░░███╗  ░░░░░░░ 
...
powercfg -setdcvalueindex %ACTIVE_GUID% 54533251-82be-4824-96c1-47b60b740d00 0cc5b647-c1df-4637-891a-dec35c318583 0
...
reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\0cc5b647-c1df-4637-891a-dec35c318584" /v "ValueMax" /t REG_DWORD /d "0" /f
powercfg -setacvalueindex SCHEME_CURRENT SUB_PROCESSOR 0cc5b647-c1df-4637-891a-dec35c318584 0
powercfg -setdcvalueindex SCHEME_CURRENT SUB_PROCESSOR 0cc5b647-c1df-4637-891a-dec35c318584 0
reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\PriorityControl" /v "Win32PrioritySeparation" /t REG_DWORD /d "26" /f
...
powercfg -setacvalueindex scheme_current sub_processor PERFBOOSTMODE 0
powercfg -setacvalueindex scheme_current sub_processor PERFBOOSTPOLICY 0
...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "CsEnabled" /t REG_DWORD /d 0 /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "PerfBoostMode" /t REG_DWORD /d 0 /f
...
chcp 65001 >nul 2>&1
echo Nota: Se notate bug o cali di fps nella versione Agressivia rieseguite il tweak in versione Safe che andrà a eliminare le modifiche applicate con la versione aggressiva tenendo Le ottimizazioni safe. Ovviamente è obblicatorio riavviare il PC per apportare le modifiche.
pause 
